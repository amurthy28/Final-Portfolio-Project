      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item">
            <a className="nav-link" href="#/CreateAccount/" title="Create your account here" >Create Account</a>
          </li>
          {/* <li className="nav-item">
          ...
          <li className="nav-item">
            <a className="nav-link" href="#/alldata/" title="All data here">AllData</a>
          </li>          
        </ul>
      </div>
    </nav>
